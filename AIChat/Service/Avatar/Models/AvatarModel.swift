...
struct AvatarDescriptionBuilder {
    ...
    var characterDescription: String {
        let prefix = charcaterOption.startsWithVowel ? "An" : "A"
        return "\(prefix) \(charcaterOption.rawValue) that is \(characterAction.rawValue) in the \(characterLocation.rawValue)"
    }
}
